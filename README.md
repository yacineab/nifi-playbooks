...
Prior to executing this role, the NiFi distribution must be accessible on the target system at `{{ nifi_base_dir }}/nifi-{{ nifi_version }}/`
...
# A complete list of IP addresses for each node within the NiFi cluster
